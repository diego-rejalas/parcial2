...
namespace parcial2.Controllers
{
    public class CiudadesController : Controller
    {
        ...
        {
            var api = new HttpClient();
            var json = await api.GetStringAsync("https://localhost:44362/ciudades/" + id);
        ...
        public async Task<ActionResult> Create(Models.CiudadesModel ciudades)
        {
            try
            {
                ...
                var response = await api.PostAsync("https://localhost:44362/api/ciudades/agregar", data);
        ...
        {
            var api = new HttpClient();
            var json = await api.GetStringAsync("https://localhost:44362/api/ciudades/obtener/" + id);
            Models.CiudadesModel ciudades = JsonConvert.DeserializeObject<CiudadesModel>(json);
            return View(ciudades);
        }
        ...
        public async Task<ActionResult> Edit(int id, Models.CiudadesModel ciudades)
        {
            try
            {
                ...
                var response = await api.PutAsync("https://localhost:44362/api/ciudades/editar/" + ciudades.Id, data);
        ...
        public async Task<ActionResult> Delete(int id, IFormCollection collection)
        {
            ...
            {
                var api = new HttpClient();
                var response = await api.DeleteAsync("https://localhost:44362/api/ciudades/editar/" + id);
