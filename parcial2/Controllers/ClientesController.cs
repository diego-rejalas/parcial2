...
namespace parcial2.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var json = await api.GetStringAsync("https://localhost:44362/ListClientes/");
        ...
        {
            var api = new HttpClient();
            var json = await api.GetStringAsync("https://localhost:44362/api/clientes/obtener/" + id);
        ...
        public async Task<ActionResult> Create(Models.ClientesModel cliente)
        {
            try
            {
                ...
                var response = await api.PostAsync("https://localhost:44362/api/clientes/agregar", data);
        ...
        public async Task<ActionResult> Edit(int id, Models.ClientesModel cliente)
        {
            try
            {
                ...
                var response = await api.PutAsync("https://localhost:44362/api/clientes/editar/" + cliente.Id, data);
        ...
        public async Task<ActionResult> Delete(int id, IFormCollection collection)
        {
            try
            {
                ...
                var api = new HttpClient();
                var response = await api.DeleteAsync("https://localhost:44362/api/clientes/eliminar/" + id);
        ...
        public async Task<ActionResult> getCiudades()
        {
            ...
            var api = new HttpClient();
            var json = await api.GetStringAsync("https://localhost:44362/ListCiudades/");
